<x-app-layout>
    ...
    <div class="w-1/2 m-auto border-[1px]">
        <h1 class="font-bold text-xl p-4 sticky top-0 border-b-[1px] bg-white bg-opacity-30 backdrop-filter backdrop-blur-lg">{{ __('Home') }}</h1>
        <div class="border-b-[1px] p-4 grid grid-cols-12">
            <div class="col-span-1">
                <img class="h-14 rounded-full" src="{{ asset('/assets/images/'. Auth::user()->photo) }}" alt="">
            </div>
            <div class="px-3 col-span-11">
                <form action="" method="post">
                    ...
                    <textarea id="tweet-textarea" class="w-full resize-none border-0 focus:ring-transparent rounded-md p-2 overflow-hidden text-xl" rows="1" max="10" maxlength="100" placeholder="What is happening?!"></textarea>
